    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><?php cek_session("E-Learning MINU PUTRI", "Pengajar"); ?></a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    ?>
                    <li>      
                        <a class="<?php if(@$_GET['page'] == 'pengajar') { echo 'active-menu'; } ?>" href="?page=pengajar"><i class="fa fa-book"></i>Data Guru</a>
                    </li>

                    <li>
                        <a class="<?php if(@$_GET['page'] == 'siswa') { echo 'active-menu'; } ?>" href="?page=siswa"><i class="fa fa-book"></i>Data Siswa</a>
                    </li>

                    <li>
                        <a class="<?php if(@$_GET['page'] == 'siswaregistrasi') { echo 'active-menu'; } ?>" href="?page=siswaregistrasi"><i class="fa fa-comment"></i>Registrasi Siswa</a>
                    </li>  
                    <?php
                    }
                    ?>
                    ...
                    <li>
                        <a class="<?php if(@$_GET['page'] == 'absensi') { echo 'active-menu'; } ?>" href="?page=absensi"><i class="fa fa-table"></i>Absensi</a>
                    </li>
                    <li>
                        <a class="<?php if(@$_GET['page'] == 'rumus') { echo 'active-menu'; } ?>" href="?page=rumus"><i class="fa fa-table"></i>Penilaian</a>
                    </li>
                    <li>
                    ...
                    <!-- <li><a href="inc/grafik.php">Informasi Nilai Siswa</a></li> -->
                </ul>
            </div>
        </nav>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                } else if(@$_GET['page'] == 'rumus') {
                    include "inc/rumus.php";
                }else {
