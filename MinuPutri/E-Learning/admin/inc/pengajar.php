...
<div class="row">
    ...
    <?php
	            ...
	            <div class="panel-body">
	            	<div class="table-responsive">
                        <table width="100%">
							...
							<tr>
                        		<td align="right"><b>Tahun Ajar</b></td>
                        		<td align="center">:</td>
	        ...
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
					<form method="post" action="?page=pengajar&action=prosestambah" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" class="form-control" placeholder="Ex.n@gmail.com" />
                        </div>
                        <div class="form-group">
                            <label>Alamat *</label>
						...
						<div class="form-group">
                            ...
                            <textarea type="text" name="tahun_ajar" class="form-control" placeholder="2020/2021" required></textarea>
                        </div>
						<div class="form-group">
                            <label>Foto</label>
		...
		$tahun_ajar = @mysqli_real_escape_string($db, $_POST['tahun_ajar']);
		...
		if($nama_gambar != '') {
			if(move_uploaded_file($sumber, $target.$nama_gambar)) {
				mysqli_query($db, "INSERT INTO tb_pengajar VALUES('', '$nip', '$nama_lengkap', '$tempat_lahir', '$tgl_lahir', '$jenis_kelamin', '$agama', '$no_telp', '$email', '$alamat', '$jabatan', '$tahun_ajar','$nama_gambar', '$web', '$username', md5('$password'), '$password', '$status')") or die ($db->error);
			...
			mysqli_query($db, "INSERT INTO tb_pengajar VALUES('', '$nip', '$nama_lengkap', '$tempat_lahir', '$tgl_lahir', '$jenis_kelamin', '$agama', '$no_telp', '$email', '$alamat', '$jabatan', '$tahun_ajar', 'anonim.png', '$web', '$username', md5('$password'), '$password', '$status')") or die ($db->error);
			echo '<script>window.location="?page=pengajar";</script>';
		}
	        ...
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
					<form method="post" action="?page=pengajar&action=prosesedit&id=<?php echo $data['id_pengajar']; ?>" enctype="multipart/form-data">
						...
						<div class="form-group">
                            <label>Tahun ajar</label>
                            <textarea type="text" name="tahun_ajar" value="<?php echo $data['tahun_ajar']; ?>" class="form-control" required ></textarea>
                        </div>
						<div class="form-group">
                            <label>Foto</label>
		...
		if($nama_gambar == '') {
			mysqli_query($db, "UPDATE tb_pengajar SET nip = '$nip', nama_lengkap = '$nama_lengkap', tempat_lahir = '$tempat_lahir', tgl_lahir = '$tgl_lahir', jenis_kelamin = '$jenis_kelamin', agama = '$agama', no_telp = '$no_telp', email = '$email', alamat = '$alamat', jabatan = '$jabatan', tahun_ajar = '$tahun_ajar',  username = '$username', password = md5('$password'), pass = '$password', status = '$status' WHERE id_pengajar = '$id'") or die ($db->error);			
			echo '<script>window.location="?page=pengajar";</script>';
		} else {
			if(move_uploaded_file($sumber, $target.$nama_gambar)) {
				mysqli_query($db, "UPDATE tb_pengajar SET nip = '$nip', nama_lengkap = '$nama_lengkap', tempat_lahir = '$tempat_lahir', tgl_lahir = '$tgl_lahir', jenis_kelamin = '$jenis_kelamin', agama = '$agama', no_telp = '$no_telp', email = '$email', alamat = '$alamat', jabatan = '$jabatan',tahun_ajar = '$tahun_ajar', foto = '$nama_gambar', username = '$username', password = md5('$password'), pass = '$password', status = '$status' WHERE id_pengajar = '$id'") or die ($db->error);			
				echo '<script>window.location="?page=pengajar";</script>';
			} else {
