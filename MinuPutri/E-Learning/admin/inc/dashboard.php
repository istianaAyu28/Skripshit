...
<div class="row">
    <div class="col-md-12">
        <div class="alert alert-success">
            <strong> Selamat datang <?php echo "<u>".$data_terlogin['nama_lengkap']."</u> di halaman "; cek_session("<b><i>E-Learning SD MINU PUTRI</i></b>", "<b><i>pengajar (guru)</i></b>"); ?>
        </div>
    </div>
</div>
<?php
    ...
    <div class="row">
        ...
        <div class="col-md-4 mt-3 ml-5">
            <div class="card shadow " style="width: 18rem; box-shadow: 1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px; cursor:pointer;">
              ...
              <img class="myimg" src="../uploadimg/file3.png" alt="Card" width="300" height="200">
              <div class="card-body">
                <p class="card-text"> <a class="<?php if(@$_GET['page'] == 'tugas') { echo 'active-menu'; } ?>" href="?page=tugas" style="text-decoration: none;">Kelola Tugas <i class="fa fa-book ml-3"></i></a></p>
              </div>
            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        if(@$_POST['simpan']) {
                            ...
                            if($nama_gambar == '') {
                                mysqli_query($db, "UPDATE tb_pengajar SET nip = '$nip', nama_lengkap = '$nama_lengkap', tempat_lahir = '$tempat_lahir', tgl_lahir = '$tgl_lahir', jenis_kelamin = '$jenis_kelamin', agama = '$agama', no_telp = '$no_telp', email = '$email', alamat = '$alamat', jabatan = '$jabatan', tahun_ajar = '$tahun_ajar', username = '$username', password = md5('$password'), pass = '$password' WHERE id_pengajar = '$_SESSION[pengajar]'") or die ($db->error);          
                                echo '<script>window.location="./";</script>';
                            } else {
                                if(move_uploaded_file($sumber, $target.$nama_gambar)) {
                                    mysqli_query($db, "UPDATE tb_pengajar SET nip = '$nip', nama_lengkap = '$nama_lengkap', tempat_lahir = '$tempat_lahir', tgl_lahir = '$tgl_lahir', jenis_kelamin = '$jenis_kelamin', agama = '$agama', no_telp = '$no_telp', email = '$email', alamat = '$alamat', foto = '$nama_gambar', jabatan = '$jabatan', tahun_ajar = '$tahun_ajar', username = '$username', password = md5('$password'), pass = '$password' WHERE id_pengajar = '$_SESSION[pengajar]'") or die ($db->error);           
                                    echo '<script>window.location="./";</script>';
                                } else {
